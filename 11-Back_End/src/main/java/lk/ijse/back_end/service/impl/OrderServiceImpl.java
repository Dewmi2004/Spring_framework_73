...
//    }
    ...
    public void saveOrder(OrderDTO orderDTO) {
        ...
        CustomerEntity customerId = customerRepository.findById(Integer.valueOf(orderDTO.getCustomerId())).get();
        ItemEntity itemId = itemRepository.findById(Integer.valueOf(orderDTO.getItemId())).get();
        ItemEntity itemUnitPrice = itemRepository.findById(Integer.valueOf(itemId.getPrice())).get();
        ItemEntity itemAvailable = itemRepository.findById(Integer.valueOf(itemId.getQuantity())).get();
        if(!customerRepository.existsById(Integer.valueOf(orderDTO.getCustomerId()))) {
            throw new RuntimeException("Customer Not Found");
        }
        if(!itemRepository.existsById(Integer.valueOf(orderDTO.getItemId()))) {
